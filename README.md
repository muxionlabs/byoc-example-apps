...
| Realtime Transcription | Real-time video transcription pipeline that generates SRT subtitles and optionally integrates them back into the stream. | @JJassonn69, Muxion Labs | AI, Realtime, Transcription | [Repo](https://github.com/JJassonn69/project-transcript) | - |
